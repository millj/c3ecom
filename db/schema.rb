...
ActiveRecord::Schema.define(version: 20151016054345) do
  ...
  create_table "fct_special_instructions", force: true do |t|
  ...
  create_table "fct_wms_carton_asn_controls", force: true do |t|
    t.integer  "exported"
    t.string   "store_code"
    t.string   "sscc"
    t.string   "to_number"
  ...
  create_table "mb_order_status_a1ws", force: true do |t|
    t.string   "order_id"
